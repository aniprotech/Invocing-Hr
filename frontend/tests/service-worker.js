...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=105', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=105', 'DELETE'));
...
[
    ['/styles.css?v=105', 'the stylesheet'],
    ['/mobile.css?v=105', 'the mobile stylesheet'],
    ['/app.js?v=105', 'the script bundle'],
