...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=92', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=92', 'DELETE'));
...
[
    ['/styles.css?v=92', 'the stylesheet'],
    ['/mobile.css?v=92', 'the mobile stylesheet'],
    ['/app.js?v=92', 'the script bundle'],
