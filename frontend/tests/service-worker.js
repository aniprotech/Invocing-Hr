...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=112', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=112', 'DELETE'));
...
[
    ['/styles.css?v=112', 'the stylesheet'],
    ['/mobile.css?v=112', 'the mobile stylesheet'],
    ['/app.js?v=112', 'the script bundle'],
