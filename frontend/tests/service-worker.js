...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=86', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=86', 'DELETE'));
...
[
    ['/styles.css?v=86', 'the stylesheet'],
    ['/mobile.css?v=86', 'the mobile stylesheet'],
    ['/app.js?v=86', 'the script bundle'],
