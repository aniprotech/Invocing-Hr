...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=103', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=103', 'DELETE'));
...
[
    ['/styles.css?v=103', 'the stylesheet'],
    ['/mobile.css?v=103', 'the mobile stylesheet'],
    ['/app.js?v=103', 'the script bundle'],
