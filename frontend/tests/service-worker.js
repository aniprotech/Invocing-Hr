...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=104', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=104', 'DELETE'));
...
[
    ['/styles.css?v=104', 'the stylesheet'],
    ['/mobile.css?v=104', 'the mobile stylesheet'],
    ['/app.js?v=104', 'the script bundle'],
