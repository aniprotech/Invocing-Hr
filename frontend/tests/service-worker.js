...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=113', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=113', 'DELETE'));
...
[
    ['/styles.css?v=113', 'the stylesheet'],
    ['/mobile.css?v=113', 'the mobile stylesheet'],
    ['/app.js?v=113', 'the script bundle'],
