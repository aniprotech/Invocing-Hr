...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=72', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=72', 'DELETE'));
...
[
    ['/styles.css?v=72', 'the stylesheet'],
    ['/mobile.css?v=72', 'the mobile stylesheet'],
    ['/app.js?v=72', 'the script bundle'],
