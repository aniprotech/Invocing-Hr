...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=102', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=102', 'DELETE'));
...
[
    ['/styles.css?v=102', 'the stylesheet'],
    ['/mobile.css?v=102', 'the mobile stylesheet'],
    ['/app.js?v=102', 'the script bundle'],
