...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=98', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=98', 'DELETE'));
...
[
    ['/styles.css?v=98', 'the stylesheet'],
    ['/mobile.css?v=98', 'the mobile stylesheet'],
    ['/app.js?v=98', 'the script bundle'],
