...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=95', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=95', 'DELETE'));
...
[
    ['/styles.css?v=95', 'the stylesheet'],
    ['/mobile.css?v=95', 'the mobile stylesheet'],
    ['/app.js?v=95', 'the script bundle'],
