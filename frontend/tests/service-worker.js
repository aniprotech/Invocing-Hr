...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=83', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=83', 'DELETE'));
...
[
    ['/styles.css?v=83', 'the stylesheet'],
    ['/mobile.css?v=83', 'the mobile stylesheet'],
    ['/app.js?v=83', 'the script bundle'],
