...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=85', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=85', 'DELETE'));
...
[
    ['/styles.css?v=85', 'the stylesheet'],
    ['/mobile.css?v=85', 'the mobile stylesheet'],
    ['/app.js?v=85', 'the script bundle'],
