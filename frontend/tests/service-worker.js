...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=88', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=88', 'DELETE'));
...
[
    ['/styles.css?v=88', 'the stylesheet'],
    ['/mobile.css?v=88', 'the mobile stylesheet'],
    ['/app.js?v=88', 'the script bundle'],
