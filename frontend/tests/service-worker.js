...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=97', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=97', 'DELETE'));
...
[
    ['/styles.css?v=97', 'the stylesheet'],
    ['/mobile.css?v=97', 'the mobile stylesheet'],
    ['/app.js?v=97', 'the script bundle'],
