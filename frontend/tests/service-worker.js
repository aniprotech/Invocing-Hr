...
check('never caches a POST', !intercepts(h, ORIGIN + '/styles.css?v=91', 'POST'));
check('never caches a DELETE', !intercepts(h, ORIGIN + '/styles.css?v=91', 'DELETE'));
...
[
    ['/styles.css?v=91', 'the stylesheet'],
    ['/mobile.css?v=91', 'the mobile stylesheet'],
    ['/app.js?v=91', 'the script bundle'],
