...
PLATFORM_SETTINGS = [
    ...
    Setting("landing.features_intro", "Features: paragraph", "Landing", "longtext",
            "The things people use every day, on both sides of the business."),
    Setting("landing.how_eyebrow", "How: strapline", "Landing", "text",
            "Getting started"),
    Setting("landing.how_title", "How: heading", "Landing", "text",
            "How to use aniprotech"),
    ...
    Setting("landing.install_title", "Install: heading", "Landing", "text",
            "Put aniprotech on your device"),
    Setting("landing.install_intro", "Install: paragraph", "Landing", "longtext",
            "There is nothing to download from an app store. It installs from "
            "your browser in a few taps and then opens full screen, with its "
            "own icon, like any other app."),
